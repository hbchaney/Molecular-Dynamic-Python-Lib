...
def xyz_appender(coord,filename):
    ...
    id_list = []
    for coords in coord: 
        id_list.append(coords[4])
    
        
    last_num = str(max(id_list)) + '\n'
...
def rand_rotator(coords_box):
    ...
    '''   
    #************************************************************************************************#  
    changes notes = I am changing the parameters in the hopes that the rotation will not be effecting       
    anything just the translation  
    '''  
    # psi_rand = 0 
    # theta_rand = 0 
    # phi_rand = 0 
    ...
    #************************************************************************************************#    
    '''
    # coords = Translation(coords,center_rev)
...
def rand_box(dim,coords_box):
    ...
    '''
    #*****************************************************************************************#
    space for edit that makes all the coordinates positive
    '''
...
def main(): 
    x = rdx_parse('dump.mono_relax_trial4-1.rdx',36000)
    x = coord_mult(x)
    x = rand_box(2,x)
    
    xyz_appender(x,'t1_2x2.xyz')
